 ...
 xml.channel do
   ...
   @maps.each do |map|
     xml.item do
       ...
       xml.description "<iframe src='http://mapknitter.org/embed/"+map.slug+"' style='border:none;'></iframe><p>"+map.description.to_s+"</p><p>View map details: http://mapknitter.org/maps/"+map.slug+"</p>"
