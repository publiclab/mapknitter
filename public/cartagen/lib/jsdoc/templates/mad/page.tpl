...
<title>{+data.index.mad.title+} &raquo; {+data.overview.name+}</title>
<link href="default.css" type="text/css" rel="stylesheet" media="all" />
<link href="pages.css"   type="text/css" rel="stylesheet" media="all" />
...
<div id="header">
	<ul>
		...
		<li><a href="{+data.file+}">{+data.overview.name+}</a></li>
	</ul>
</div>
<!--============ /HEADER ============-->
...
<!--============== PAGE =============-->
<div id="page">
<h1>Your custom content is here.</h1>
</div>
<!--============= /PAGE =============-->
